...
const SLIDES: Slide[] = [
  ...
  {
    key: 'mentor',
    title: 'Inclick siempre presente',
    description:
      'Recibe recordatorios, desafíos y seguimiento personalizado con la plataforma de Inclick.',
    artwork: createArtworkProps({
      base: ['#2E4AF5', '#1D2EC7'],
      accent: '#F97316',
      secondary: '#60A5FA',
  ...
  },
  {
    ...
    description:
      'Conecta con tu Inclick, comparte avances y suma victorias en tu aprendizaje.',
    artwork: createArtworkProps({
      base: ['#2B3BFA', '#1825B3'],
      accent: '#38BDF8',
      secondary: '#F472B6',
  ...
  return (
    <View style={styles.finalActions}>
      <Link href="/(auth)/register" asChild>
        <TouchableOpacity style={[styles.primaryButton, styles.fullWidthButton]} activeOpacity={0.85}>
          <Text style={styles.primaryLabel}>Crear cuenta</Text>
        </TouchableOpacity>
      </Link>
      <Link href="/(auth)/login" asChild>
        <TouchableOpacity style={[styles.secondaryButton, styles.fullWidthButton]} activeOpacity={0.85}>
          <Text style={styles.secondaryLabel}>Ingresar</Text>
        </TouchableOpacity>
      </Link>
